...
// SearchAvailabilitiesByDatesByRoomID returns true if availability exists for roomID, and false if no availability
func (m *testDBRepo) SearchAvailabilitiesByDatesByRoomID(start, end time.Time, roomID int) (bool, error) {
	// set up a test time
	layout := "2006-01-02"
	str := "2049-12-31"
...
func (m *testDBRepo) SearchAvailabilitiesForAllRooms(start, end time.Time) ([]models.Room, error) {
